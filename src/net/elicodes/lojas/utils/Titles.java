...
public class Titles {
	...
	public static void send(Player p, String title, String subtitle, int duration, int fadeIn, int fadeOut) {
		Titles t = new Titles(title, subtitle, fadeIn, duration, fadeOut);
